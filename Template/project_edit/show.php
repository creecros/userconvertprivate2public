...
<?php endif ?>
<form method="post" action="<?= $this->url->href('UserConvertProjectExtension', 'cp_update', array('plugin' => 'ConvertPrivate', 'project_id' => $project['id'], 'redirect' => 'edit')) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
